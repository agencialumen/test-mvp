...
import { ArrowLeft, Loader2, Upload, Crown, Instagram, Twitter, Youtube, Camera } from "lucide-react"
        ...
        if (userProfile && userProfile.userType === "creator") {
          ...
          setFormData({
            ...
            socialLinks: {
              ...
              youtube: creatorProfile.socialLinks?.youtube || "",
            },
          })
        }
      } catch (error) {
      ...
      <main className="max-w-md mx-auto p-6 space-y-6 pb-20">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex: Lifestyle, Beauty, Fitness..."
                className="bg-transparent"
              />
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Conecte suas outras redes sociais</p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-muted-foreground flex items-center">
                <span className="w-4 h-4 mr-2 bg-black rounded text-white text-xs flex items-center justify-center font-bold">
                  T
                </span>
                TikTok
              </label>
